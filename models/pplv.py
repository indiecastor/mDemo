...
pplv_alpha: float = random.uniform(LV_ALPHA_MIN, LV_ALPHA_MAX)
pplv_beta: float  = random.uniform(LV_BETA_MIN, LV_BETA_MAX)
pplv_gamma: float = random.uniform(LV_GAMMA_MIN, LV_GAMMA_MAX)
pplv_delta: float = random.uniform(LV_DELTA_MIN, LV_DELTA_MAX)

pplv_init_prey_pop: float = random.uniform(LV_INIT_PREY_POP_MIN, LV_INIT_PREY_POP_MAX)
pplv_init_pred_pop: float = random.uniform(LV_INIT_PREDATOR_POP_MIN, LV_INIT_PREDATOR_POP_MAX)
...
def randomize() -> None:
    ...
    alpha = random.uniform(LV_ALPHA_MIN, LV_ALPHA_MAX)
    beta  = random.uniform(LV_BETA_MIN, LV_BETA_MAX)
    gamma = random.uniform(LV_GAMMA_MIN, LV_GAMMA_MAX)
    delta = random.uniform(LV_DELTA_MIN, LV_DELTA_MAX)

    dpg.configure_item('pplv_alpha', default_value=alpha)
    dpg.configure_item('pplv_beta', default_value=beta)
    dpg.configure_item('pplv_gamma', default_value=gamma)
    dpg.configure_item('pplv_delta', default_value=delta)
